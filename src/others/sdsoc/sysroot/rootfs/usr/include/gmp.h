...
#define __GMP_CC "arm-xilinx-linux-gnueabi-gcc  -march=armv7-a -marm -mfpu=neon  -mfloat-abi=hard -mcpu=cortex-a9 "
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/tmp/scratch/petalinux-yocto/yocto_sdk_minimal_2017.2/build/tmp/work/cortexa9hf-neon-xilinx-linux-gnueabi/gmp/6.1.1-r0=/usr/src/debug/gmp/6.1.1-r0 -fdebug-prefix-map=/tmp/scratch/petalinux-yocto/yocto_sdk_minimal_2017.2/build/tmp/sysroots/x86_64-linux= -fdebug-prefix-map=/tmp/scratch/petalinux-yocto/yocto_sdk_minimal_2017.2/build/tmp/sysroots/zynq-generic="
